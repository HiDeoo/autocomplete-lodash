...
export default class AutocompleteLodashProvider {
   ...
   * @type {string}
   */
  static selector = '.source.js, .source.jsx, .source.js.jsx, source.js.embedded.html';

  /**
   * Selectors where the package is disabled.
   * @type {string}
   */
  static disableForSelector = '.source.js .comment, .source.jsx .comment, .source.js.jsx .comment, source.js.embedded.html .comment';
